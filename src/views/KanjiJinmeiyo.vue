<template>
  <div class="min-h-screen bg-gradient-to-br from-base-100 via-base-200 to-base-100">
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="text-center mb-8">
        <h1 class="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
          👤 Kanjis Jinmeiyō (人名用漢字)
        </h1>
        <p class="text-lg text-base-content/70 max-w-3xl mx-auto">
          Os 863 kanjis aprovados para uso em nomes próprios no Japão
        </p>
      </div>
      ...
      <div v-if="!loaded" class="text-center mb-8">
        ...
        >
          ...
          {{ loading ? 'Carregando...' : 'Carregar Kanjis de Nomes' }}
        </button>
        <p class="text-sm text-base-content/60 mt-2">
          Kanjis permitidos para registro de nomes no Japão
        </p>
      </div>
      ...
      <div v-if="loading" class="flex flex-col justify-center items-center py-20">
        ...
        <p class="text-lg">Carregando kanjis Jinmeiyō...</p>
      </div>
      ...
      <div v-else-if="loaded" class="space-y-8">
        ...
        <div class="max-w-4xl mx-auto">
          <div class="alert alert-info">
            ...
            <div>
              <h3 class="font-bold">Sobre os Kanjis Jinmeiyō</h3>
              <div class="text-sm">Estes kanjis são aprovados para uso em nomes próprios registrados oficialmente no Japão, complementando os kanjis Jōyō.</div>
            </div>
          </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
          <div class="stats stats-vertical lg:stats-horizontal shadow w-full">
            <div class="stat">
              ...
              <div class="stat-desc">Kanjis para nomes</div>
            </div>
            ...
            <div class="stat">
              ...
              <div class="stat-title">Conhecidos</div>
    ...
    <!-- Modal de Detalhes (igual aos anteriores) -->
        ...
        <div v-else-if="kanjiApiDetails" class="space-y-6">
          <div class="text-center">
            ...
            <div class="flex gap-2 justify-center flex-wrap">
              <div class="badge badge-primary badge-lg">Jinmeiyō</div>
...
const filteredKanjis = computed(() => {
  if (!searchQuery.value) return kanjis.value
  return kanjis.value.filter(k => k.includes(searchQuery.value))
})
...
const loadKanjis = async () => {
  const kanjiSet = await fetchJinmeiyoSet()
...
const saveLearnedState = () => {
  localStorage.setItem('kanji-jinmeiyo-learned', JSON.stringify([...learnedKanjis.value]))
}

const loadLearnedState = () => {
  try {
    const saved = localStorage.getItem('kanji-jinmeiyo-learned')
    if (saved) {
